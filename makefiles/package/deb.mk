...
_THEOS_DEB_PACKAGE_CONTROL_PATH := $(THEOS_PROJECT_DIR)/control
...
internal-package::
	$(ECHO_NOTHING)COPYFILE_DISABLE=1 $(FAKEROOT) -r$(ECHO_END)
	$(ECHO_NOTHING)dpkg-deb -b "$(THEOS_STAGING_DIR)" "$(_THEOS_DEB_PACKAGE_FILENAME)" $(STDERR_NULL_REDIRECT) $(ECHO_END)
